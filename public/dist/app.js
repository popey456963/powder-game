...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../styles/css/style.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"molecules/Particle.js":[function(require,module,exports) {
...
function () {
  ...
  _createClass(Particle, [{
    ...
    key: "move",
    value: function move(p, y) {
      if (typeof y !== 'undefined') p += y * Globals.width.x;
      Globals.grid.setMolecule(new Globals.Empty({
        pos: this.pos
      }));
      this.pos += p;
    ...
    key: "getMolecule",
    value: function getMolecule(p, y) {
      if (typeof y !== 'undefined') p += y * Globals.width.x;
      return Globals.grid.getMolecule(this.pos + p);
    }
  }, {
    key: "getType",
    value: function getType(p, y) {
      if (typeof y !== 'undefined') p += y * Globals.width.x;
...
function (_Particle) {
  ...
  function Empty(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Empty).call(this, options));
    _this.type = 1;
    return _this;
  }
...
function (_Particle) {
  ...
  function Powder(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Powder).call(this, options));
    _this.type = 200;
    return _this;
  }
...
module.exports = Snow;
},{"./Powder":"molecules/Powder.js"}],"molecules/Sand.js":[function(require,module,exports) {
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_Powder) {
  _inherits(Sand, _Powder);

  function Sand(options) {
    var _this;

    _classCallCheck(this, Sand);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Sand).call(this, options));
    _this.type = 201;
    return _this;
  }
  ...
  _createClass(Sand, [{
    ...
    key: "tick",
    value: function tick() {
      _get(_getPrototypeOf(Sand.prototype), "tick", this).call(this);
    }
  }]);
...
module.exports = Sand;
},{"./Powder":"molecules/Powder.js"}],"molecules/Block.js":[function(require,module,exports) {
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
},{"./Particle.js":"molecules/Particle.js"}],"modules/Utils.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(Grid, [{
    ...
    key: "setMolecule",
    value: function setMolecule(molecule) {
...
var Sand = require('../molecules/Sand.js');

var Block = require('../molecules/Block.js');
...
function () {
  function Game(target) {
    ...
    var canvasContainer = document.getElementById(target + "Container");
    ...
    for (var i = 0; i < Globals.width.x; i++) {
      Globals.grid.setMolecule(new Block({
        pos: i
      }));
      Globals.grid.setMolecule(new Block({
        pos: (Globals.width.y - 1) * Globals.width.x + i
      }));
    }

    for (var _i = 1; _i < Globals.width.y; _i++) {
      Globals.grid.setMolecule(new Block({
        pos: Globals.width.x * _i
      }));
      Globals.grid.setMolecule(new Block({
        pos: Globals.width.x * _i + Globals.width.x - 1
      }));
    }
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                for (i = 1; i < Globals.width.x - 1; i++) {
                  if (Math.random() < 0.01) {
                    Globals.grid.setMolecule(new Snow({
                      pos: i + Globals.width.x
                    }));
                  } else if (Math.random() > 0.99) {
                    Globals.grid.setMolecule(new Sand({
                      pos: i + Globals.width.x
                    }));
                  }
...
module.exports = Game;
},{"../molecules/Empty.js":"molecules/Empty.js","../molecules/Snow.js":"molecules/Snow.js","../molecules/Sand.js":"molecules/Sand.js","../molecules/Block.js":"molecules/Block.js","./Utils.js":"modules/Utils.js","./Grid.js":"modules/Grid.js"}],"app.js":[function(require,module,exports) {
"use strict";

require("babel-polyfill");

require("..\\styles\\css\\style.scss");
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","..\\styles\\css\\style.scss":"../styles/css/style.scss","./modules/Game":"modules/Game.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
